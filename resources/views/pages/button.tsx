...
export default function Welcome({ lirnui }: { lirnui: any })
{
    ...
    return (<>
        <Head>
            <title>{`${lirnui} - SECRET BUTTON`}</title>
        </Head>
        <div className="mx-auto max-w-screen-2xl px-4 py-8 lg:px-6 lg:py-16">
            <div className="text-center">
                <div className="mx-auto max-w-screen-sm text-center">
			    	...
			    	>
                        This is button link from home page, showing how custom component InertiaLinkButton 
                        is working
			    	</h1>
			    </div>
                    ...
                    <CardBody>
                        <div className="grid grid-cols-6 md:grid-cols-12 gap-6 md:gap-4 items-center justify-center">
                            <div className="relative col-span-6 md:col-span-12">
                                ...
                                <div className="p-2"></div>
                                <InertiaLink href="/secret">This link go to Google.com</InertiaLink>
                                
                                <div className="p-2"></div>
                                <InertiaLinkButton href="/">Home</InertiaLinkButton>
                            </div>
                        </div>
                    </CardBody>
                </Card>
